        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">SongAh Choi</a></h1>
              <span className="email"><i className="icon-mail"></i> risingcsa@gmail.com</span><br></br>
            </div>
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://github.com/dev-csa" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
                <li><a href="https://dev-csa.github.io/" target="_blank" rel="noopener noreferrer"><i className="icon-blogger2"></i></a></li>
              </ul>
            </nav>
            <div className="colorlib-footer">
              <p><small>
                  Made with <i className="icon-heart3" aria-hidden="true" /> and <i className="icon-beer" aria-hidden="true"></i><br></br>
                  Copyright ©2020
              </small></p>
